...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return getPowerState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default PowerState getPowerState(java.util.Map<String, String> context)
    {
        return _iceI_getPowerStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<PowerState> getPowerStateAsync()
    {
        return _iceI_getPowerStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<PowerState> getPowerStateAsync(java.util.Map<String, String> context)
    {
        return _iceI_getPowerStateAsync(context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<PowerState> _iceI_getPowerStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<PowerState> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getPowerState", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     PowerState ret;
                     ret = PowerState.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default void setPowerState(PowerState powerState)
    {
        setPowerState(powerState, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setPowerState(PowerState powerState, java.util.Map<String, String> context)
    {
        _iceI_setPowerStateAsync(powerState, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setPowerStateAsync(PowerState powerState)
    {
        return _iceI_setPowerStateAsync(powerState, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setPowerStateAsync(PowerState powerState, java.util.Map<String, String> context)
    {
        return _iceI_setPowerStateAsync(powerState, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setPowerStateAsync(PowerState iceP_powerState, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setPowerState", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     PowerState.ice_write(ostr, iceP_powerState);
                 }, null);
        return f;
    }
